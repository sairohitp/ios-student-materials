...
progressUpdate(steps: 250, goal: 500)
progressUpdate(steps: 900, goal: 1000)
progressUpdate(steps: 750, goal: 800)
...
pacing(currentDistance: 4.5, totalDistance: 10.0, currentTime: 30.0, goalTime: 75.0)
pacing(currentDistance: 3.0, totalDistance: 5.0, currentTime: 22.0, goalTime: 45.0)
/*:
